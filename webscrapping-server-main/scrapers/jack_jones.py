...
def scrap_jack_jones(keyword, pages, json_file):
    ...
    sections = {
        "hombre": f"https://www.jackjones.com/es-es/search?q={keyword}&page={{}}",
        "mujer": f"https://www.jackjones.com/es-es/jjxx/search?q={keyword}&page={{}}",
        "niños": f"https://www.jackjones.com/es-es/ninos/search?q={keyword}&page={{}}"
    }
    ...
    try:
        for section, url_template in sections.items():
            ...
            while True:
                ...
                if not elements:
                    break  # No más productos, salir del bucle de esta sección
